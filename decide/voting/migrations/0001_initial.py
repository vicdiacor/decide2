# Generated by Django 2.0 on 2021-12-24 19:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('SO', 'Single_Option'), ('MC', 'Multiple_Choice')], default='SO', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.CharField(blank=True, default='', max_length=200, null=True, validators=[django.core.validators.RegexValidator(re.compile('^\\d+(?:,\\d+)*\\Z'), code='invalid', message='Enter only digits separated by commas.')])),
